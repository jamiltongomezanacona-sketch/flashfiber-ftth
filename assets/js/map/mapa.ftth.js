...
(function () {
  ...
  whenMapReady(() => {
    ...
    // ✅ No llamar loadFTTHLayers aquí: la primera carga la hace mapa.init.js en map.on("load") → once("idle") → App.reloadFTTH()
  ...
  function loadFTTHLayers() {
    ...
    var geojsonUrl = typeof window !== "undefined" && window.__FTTH_GEOJSON_CONSOLIDADO_URL__
